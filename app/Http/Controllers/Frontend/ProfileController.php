...
class ProfileController extends Controller
{
    ...
    public function update(Request $request, $user_id)
    {
        ...
        $request->validate([
            ...
            'resident_number' => 'required|string|max:20', // Validate the resident number
        ...
        $record->resident_number = Auth::user()->resident_number; // Use the resident number from the authenticated user
