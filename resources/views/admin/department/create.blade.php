...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0 rounded-0">
        <div class="card-header d-sm-flex align-items-center justify-content-between bg-primary text-white">
            ...
            <a href="{{ url('admin/department') }}" class="btn btn-light btn-sm shadow-sm">
                <i class="fas fa-arrow-alt-circle-left text-primary mx-2"></i>Back
            </a>
        </div>
        <div class="card-body">
            <form action="{{ url('admin/add-department') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="icon" class="form-control" placeholder="Enter Font Awesome icon class" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="form-control" rows="4" placeholder="Enter department description" required></textarea>
                </div>
